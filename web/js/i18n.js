...
const STRINGS = {
  zh: {
    ...
    log: {
      ...
      captcha: "驗證中⋯通過後自動送出", relaySent: "✅ 已送出，感謝回報！",
  ...
  en: {
    ...
    log: {
      ...
      captcha: "Verifying… it'll send automatically once you pass", relaySent: "✅ Sent — thanks for reporting!",
  ...
  es: {
    ...
    log: {
      ...
      captcha: "Verificando… se enviará automáticamente al pasar", relaySent: "✅ ¡Enviado, gracias!",
